...
namespace skyline::hle {
    ...
    static const std::array<std::pair<std::string_view, void *>, 285> NvnBootstrapLoaderTable{{
        ...
        WRAP_NVN_FUNC(QueueAcquireTexture),
        WRAP_NVN_FUNC(QueueFenceSync),
        WRAP_NVN_FUNC(QueueWaitSync),
        WRAP_NVN_FUNC(WindowBuilderSetDefaults),
        WRAP_NVN_FUNC(WindowBuilderSetDevice),
        WRAP_NVN_FUNC(WindowBuilderSetNativeWindow),
        WRAP_NVN_FUNC(WindowBuilderSetTextures),
        WRAP_NVN_FUNC(WindowBuilderSetPresentInterval),
        WRAP_NVN_FUNC(WindowBuilderSetNumActiveTextures),
        WRAP_NVN_FUNC(WindowBuilderGetNumActiveTextures),
        WRAP_NVN_FUNC(WindowBuilderGetDevice),
        WRAP_NVN_FUNC(WindowBuilderGetNumTextures),
        WRAP_NVN_FUNC(WindowBuilderGetTexture),
        WRAP_NVN_FUNC(WindowBuilderGetNativeWindow),
        WRAP_NVN_FUNC(WindowBuilderGetPresentInterval),
        WRAP_NVN_FUNC(WindowInitialize),
        WRAP_NVN_FUNC(WindowFinalize),
        WRAP_NVN_FUNC(WindowSetDebugLabel),
        WRAP_NVN_FUNC(WindowAcquireTexture),
        WRAP_NVN_FUNC(WindowGetNativeWindow),
        WRAP_NVN_FUNC(WindowGetPresentInterval),
        WRAP_NVN_FUNC(WindowSetPresentInterval),
        WRAP_NVN_FUNC(WindowSetCrop),
        WRAP_NVN_FUNC(WindowGetCrop),
        WRAP_NVN_FUNC(WindowSetNumActiveTextures),
        WRAP_NVN_FUNC(WindowGetNumActiveTextures),
        WRAP_NVN_FUNC(WindowGetNumTextures),
        WRAP_NVN_FUNC(BufferBuilderSetDefaults),
        WRAP_NVN_FUNC(BufferBuilderSetDevice),
        WRAP_NVN_FUNC(BufferBuilderSetStorage),
        WRAP_NVN_FUNC(BufferBuilderGetDevice),
        WRAP_NVN_FUNC(BufferBuilderGetMemoryPool),
        WRAP_NVN_FUNC(BufferBuilderGetMemoryOffset),
        WRAP_NVN_FUNC(BufferBuilderGetSize),
        WRAP_NVN_FUNC(BufferInitialize),
        WRAP_NVN_FUNC(BufferFinalize),
        WRAP_NVN_FUNC(BufferSetDebugLabel),
        WRAP_NVN_FUNC(BufferMap),
        WRAP_NVN_FUNC(BufferGetAddress),
        WRAP_NVN_FUNC(BufferFlushMappedRange),
        WRAP_NVN_FUNC(BufferInvalidateMappedRange),
        WRAP_NVN_FUNC(BufferGetMemoryPool),
        WRAP_NVN_FUNC(BufferGetMemoryOffset),
        WRAP_NVN_FUNC(BufferGetSize),
        WRAP_NVN_FUNC(BufferGetDebugID),
        WRAP_NVN_FUNC(SyncInitialize),
        WRAP_NVN_FUNC(SyncFinalize),
        WRAP_NVN_FUNC(SyncSetDebugLabel),
        WRAP_NVN_FUNC(SyncWait),
        WRAP_NVN_FUNC(CommandBufferInitialize),
        WRAP_NVN_FUNC(CommandBufferFinalize),
        WRAP_NVN_FUNC(CommandBufferSetDebugLabel),
        WRAP_NVN_FUNC(CommandBufferSetMemoryCallback),
        WRAP_NVN_FUNC(CommandBufferSetMemoryCallbackData),
        WRAP_NVN_FUNC(CommandBufferAddCommandMemory),
        WRAP_NVN_FUNC(CommandBufferAddControlMemory),
        WRAP_NVN_FUNC(CommandBufferGetCommandMemorySize),
        WRAP_NVN_FUNC(CommandBufferGetCommandMemoryUsed),
        WRAP_NVN_FUNC(CommandBufferGetCommandMemoryFree),
        WRAP_NVN_FUNC(CommandBufferGetControlMemorySize),
        WRAP_NVN_FUNC(CommandBufferGetControlMemoryUsed),
        WRAP_NVN_FUNC(CommandBufferGetControlMemoryFree),
        WRAP_NVN_FUNC(CommandBufferBeginRecording),
        WRAP_NVN_FUNC(CommandBufferEndRecording),
        WRAP_NVN_FUNC(CommandBufferGetMemoryCallback),
        WRAP_NVN_FUNC(CommandBufferGetMemoryCallbackData),
        WRAP_NVN_FUNC(ProgramInitialize),
        WRAP_NVN_FUNC(ProgramFinalize),
        WRAP_NVN_FUNC(ProgramSetDebugLabel),
        WRAP_NVN_FUNC(ProgramSetShaders),
        WRAP_NVN_FUNC(ProgramSetSubroutineLinkage),
    }};
    #undef WRAP_NVN_FUNC
